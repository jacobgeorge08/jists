...
import (
	...
	"github.com/jacobgeorge08/jists/internal/models"
	"github.com/jacobgeorge08/jists/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "Field cannot be more than 100 chars")
	form.CheckField(validator.NotBlank(form.Content), "content", "This field cannot be blank")
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365), "expires", "Field must be 1, 7 or 365")
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MinChars(form.NewPassword, 8), "newPassword", "This Field Must be 8 Characters Long")
	form.CheckField(validator.NotBlank(form.NewPasswordConfirmation), "newPassword", "This Field Cannot Be Blank")
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			form.AddFieldError("currentPassword", "CurrentPassword is incorrect")
